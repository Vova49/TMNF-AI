    ...
    with out_path.open("w", newline="", encoding="utf-8") as f:
        ...
        writer.writerow(
            [
                ...
                "Yaw автомобиля, рад",
                "Yaw автомобиля, град",
                "Направление движения (heading), рад",
                "Направление движения (heading), град",
                "Скорость, м/с",
                "Параметр вдоль траектории s, м",
                "Поперечное отклонение d, м (лево+/право-)",
                "Угол касательной траектории, рад",
                "Угол касательной траектории, град",
                "Разница yaw - касательная, рад",
                "Разница yaw - касательная, град",
                "Разница heading - касательная, рад",
                "Разница heading - касательная, град",
                "Индекс сегмента траектории",
                "Параметр вдоль сегмента t в [0,1]",
                "Расстояние до сегмента, м",
                "Оставшееся расстояние до конца круга, м",
                "Счетчик касаний стен",
            ]
        )
